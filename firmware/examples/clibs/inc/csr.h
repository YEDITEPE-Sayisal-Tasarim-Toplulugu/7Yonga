...
#define CSR_MHPCOUNTER_0            0xb00
#define CSR_MHPCOUNTERH_0           0xb80
...
#define hpm_stop_all_counters               (csr_write(0x320, -1))
#define hpm_start_all_counters              (csr_write(0x320, 0))
#define hpm_stop_counter(n)                 (csr_set(0x320, n))
#define hpm_start_counter(n)                (csr_clear(0x320, n))
#define hpm_set_event(n, event)             (csr_write((0x320+(n)), event))
#define hpm_get_event(n)                    (csr_read((0x320+(n))))
#define hpm_set_counter_value(n, value)     (csr_write((0xb00+(n)), value))
#define hpm_get_counter_value(n)            (csr_read((0xb00+(n))))
#define hpm_set_counterh_value(n, value)    (csr_write((0xb80+(n)), value))
#define hpm_get_counterh_value(n)           (csr_read((0xb80+(n))))
